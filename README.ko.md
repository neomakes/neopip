...
이 플랫폼은 [neomakes](https://github.com/neomakes) 에이전트 생태계의 사용자 인터페이스 레이어로 설계되었습니다. [iphoneLogger](https://github.com/neomakes/iphonelogger)의 센서 데이터가 [humanWorldModel](https://github.com/neomakes/humanWorldModel)의 행동 모델로 유입되고, 이를 기반으로 NeoPIP의 개인화된 웰니스 인텔리전스가 작동합니다.
...
- **[humanWorldModel](https://github.com/neomakes/humanWorldModel)** — VRAE 기반 행동 궤적 모델링. NeoPIP 웰니스 인텔리전스의 ML 백본으로, 개인화된 행동 예측을 생성합니다.
- **[iphoneLogger](https://github.com/neomakes/iphonelogger)** — 멀티모달 센서 로깅. NeoPIP 데이터 파이프라인에 원시 물리 데이터를 제공합니다.
...
- ML 연동: humanWorldModel이 연구 백엔드이나 아직 앱에 연결되지 않음
...
- [ ] humanWorldModel 연결하여 실제 행동 예측 구현
